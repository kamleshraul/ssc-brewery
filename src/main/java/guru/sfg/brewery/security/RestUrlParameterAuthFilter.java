...
public class RestUrlParameterAuthFilter extends AbstractCustomAuthFilter {
	...
	//move common part to parent abstract class
	/*
	@Override
	...
	*/
	...
	@Override
	protected Optional<String> getUsername(HttpServletRequest request) {
		return Optional.ofNullable(request.getParameter("Api-Key"));
	}
	
	@Override
	protected Optional<String> getPassword(HttpServletRequest request) {
		return Optional.ofNullable(request.getParameter("Api-Secret"));
	}
